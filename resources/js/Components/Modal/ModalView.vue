...
<template>
  <Teleport to="body"> 
    <div v-if="showModalView" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div class="bg-white rounded-lg shadow-md p-6 max-w-md w-full">
          ...
          <div class="text-center">
              ...
              <h3 class="mb-5 text-lg font-normal text-gray-500">View Detail</h3>
              <form action="">
                <input type="text" class="border border-gray-200 rounded-lg px-3 py-2.5 w-full mb-3" placeholder="Title" :value="items.title">
                <textarea class="border border-gray-200 rounded-lg px-3 py-2.5 w-full mb-3" placeholder="Content" :value="items.content"></textarea>
              </form>
