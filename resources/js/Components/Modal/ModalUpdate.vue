    ...
    <div v-if="showModalUpdate" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div class="bg-white rounded-lg shadow-md p-6 max-w-md w-full">
          ...
          <div class="text-center">
              ...
              <form action="">
                <input type="text" class="border border-gray-200 rounded-lg px-3 py-2.5 w-full mb-3" placeholder="Title">
                <textarea class="border border-gray-200 rounded-lg px-3 py-2.5 w-full mb-3" placeholder="Content"></textarea>
              </form>
